...
f = open('C://Users//kosmo//Desktop//team1_Django_Wed_Project//강남점_codek-room.csv', 'w',encoding='cp949', newline='')
wr = csv.writer(f)
wr.writerow(['지점명', '주소,전화번호,운영시간','카페이미지url'])

path = "C://Users//kosmo//Desktop//team1_Django_Wed_Project//chromedriver.exe"
driver = webdriver.Chrome(path)
url = "http://www.code-k.co.kr/sub/code_sub02_1.html"
driver.get(url)
...
for x in range(1):
    ...
    img_path = driver.find_element(By.XPATH,'//*[@id="cont_text"]/div[4]/ul/li[1]/img').get_attribute('src')
    print(x)
